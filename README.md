...
The real Claude probe currently requires refreshing the local OAuth login; see [validation notes](VALIDATION.md). Automated success does not mean an external PR was published.
